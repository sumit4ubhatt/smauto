...
public class WebAppRepository  extends Repository implements WebAppRepositoryInterface {
    ...
    public static final List<String> HIDE_TAB_FIELDS = Arrays.asList("myHome", "activities", "cases", "leads", "forecasts", "opportunities", "marketing",
    		"partners", "quotes", "opportunities");
    ...
    public List<? extends Tab> getWebAppTabs(Webapp webapp, User user, Map<String, Object> context) throws RepositoryException {
        ...
        for (Tab tab : tabs) {
        	if(HIDE_TAB_FIELDS.contains(tab.getString("tabId"))){
            	tab.setHidden(true);
            	continue;
            }
