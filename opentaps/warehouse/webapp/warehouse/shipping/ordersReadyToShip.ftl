...
<table class="listTable" cellspacing="0" cellpadding="5">
    ...
    <#list orders as order>
        ...
        <tr class="${rowClass}">
            ...
            <td>
            	<#assign partyCredit = delegator.findByAnd("Party", Static["org.ofbiz.base.util.UtilMisc"].toMap("partyId", order.billToPartyId)) />
            	<#if partyCredit?has_content>
            	${partyCredit.get(0).creditLimit?default(0)}
            	</#if>
            </td>
            <td class="alignRight">
