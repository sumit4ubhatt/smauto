...
public final class Parser implements ParserConstants {
  ...
  final private SQLSelect Select() throws ParseException {
    ...
    default:
      ...
      {if (true) return new SQLSelect(fieldAlls, fieldDefs, table, relations, whereCondition, havingCondition, groupBy, orderBy, offset, limit);}
    throw new Error("Missing return statement in function");
  }
  ...
  final private SQLUpdate Update() throws ParseException {
    ...
    if (jj_2_1(2147483647) && (updateSupportsFrom)) {
      jj_consume_token(FROM);
  ...
  final private SQLDelete Delete() throws ParseException {
    ...
    jj_consume_token(FROM);
    tableName = TableName();
    if (jj_2_2(2147483647) && (deleteSupportsUsing)) {
  ...
  final private void FieldDef(Map<String, FieldDef> fieldDefs, List<FieldAll> fieldAlls, Set<String> fieldAllAliases) throws ParseException {
    StaticValue v;
    ...
    case NAME:
      ...
      case PERIOD:
        ...
        case STAR:
          ...
          switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
          case EXCLUDE:
                      if (fieldAllAliases.contains(n)) {if (true) throw new ParseException("Duplicate aliasAll(" + n + ")");}
          ...
          default:
            ...
            ;
                  ...
                  fieldAlls.add(new FieldAll(n, excludeList)); {if (true) return;}
          break;
        case TYPE:
        case NAME:
          fieldName = NamePart();
          ...
          default:
            ...
            ;
                                                                     ...
                                                                     def = new FieldDefFieldValue(new FieldValue(n, fieldName), fieldAlias);
          break;
        default:
          jj_la1[45] = jj_gen;
          jj_consume_token(-1);
      ...
      case OPEN_PAREN:
        ...
        default:
          ...
          ;
                                                                     ...
                                                                     def = new FieldDefValue(v, fieldAlias);
        break;
      default:
        jj_la1[48] = jj_gen;
        switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
        ...
        default:
          ...
          ;
                                               ...
                                               def = new FieldDefFieldValue(new FieldValue(null, n), fieldAlias);
      }
      break;
    case OPEN_PAREN:
      v = MathValue();
    ...
    default:
      ...
      throw new ParseException();
        ...
        if (fieldDefs.containsKey(def.getAlias())) {if (true) throw new ParseException("duplicate alias(" + def.getAlias() + ")");}
  ...
  final private OrderByItem OrderByItem() throws ParseException {
    ...
    default:
      ...
      {if (true) return new OrderByItem(ordering, functionName, fieldName);}
    throw new Error("Missing return statement in function");
  }
  ...
  final private String ComparisonOperator() throws ParseException {
      ...
      while (true) {
        ...
        default:
          ...
          break label_22;
                ...
                sb = new StringBuilder(); sb.append(getToken(0).image);
      label_23:
      while (true) {
        switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
        case EQUALS:
    ...
    case EQUALS:
      jj_consume_token(EQUALS);
                {if (true) return getToken(0).image.toLowerCase();}
      break;
    default:
      jj_la1[84] = jj_gen;
      jj_consume_token(-1);
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x3c0000,0x40000000,0x40000000,0x40000000,0x40000000,0x40000000,0x40000000,0x40000000,0x3c0000,0x0,0x400000,0x200,0x400,0x800,0x1000,0x20000,0x10000,0x4000000,0x8000000,0x0,0x200,0x200,0x0,0x2,0x40000,0x0,0x0,0x0,0x4000002,0x0,0x4000002,0x0,0x4000002,0x4000002,0xc0,0xc0,0x8,0x0,0xc000,0x100,0x4000100,0xc0,0x0,0x800000,0x100,0x84000000,0x100,0x100,0x22,0x100,0x4000002,0x0,0x0,0x4000000,0x2,0x4000002,0x4000000,0x0,0x0,0x0,0x0,0x0,0x20,0x0,0x0,0x0,0x3000000,0x7000000,0x0,0x0,0x2,0x4000000,0x8,0x10,0x4000000,0x0,0x0,0x4000002,0x0,0x4000002,0x0,0x0,0x0,0x0,0x0,0x0,0x0,};
   }
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0x200,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x200,0x1,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x1,0x0,0x0,0x1,0x0,0x100,0x1,0x1,0x58000,0x38000,0x1,0x38000,0x1,0x38000,0x20000,0x0,0x0,0x0,0x1,0x0,0x0,0x20000,0x0,0x1,0x0,0x0,0x20000,0x0,0x0,0x0,0x0,0x20000,0x8020000,0x1,0x38000,0x0,0x38000,0x20000,0x8800000,0x8800000,0xa800000,0xa800000,0x1,0x0,0x1,0x6,0x6,0x0,0x20000,0x18,0x18,0x0,0x38000,0x0,0x0,0x78000,0x3000,0x1,0x78000,0x8020860,0x38000,0x8000000,0x20,0x8000000,0x8000000,0x8020020,0x8000000,0x8020000,};
   }
